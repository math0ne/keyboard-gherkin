...
#define AC_TL2    ACTION_LAYER_TAP_KEY(2, KC_ESC)
#define AC_TL3    ACTION_MODS_TAP_KEY(MOD_RALT, KC_C)
#define AC_TL4    ACTION_LAYER_TAP_KEY(4, KC_V)
#define AC_TL5    ACTION_LAYER_TAP_KEY(5, KC_B)
#define AC_TM1    ACTION_MODS_TAP_KEY(MOD_RSFT, KC_BSPACE)
#define AC_TM2    ACTION_MODS_TAP_KEY(MOD_LCTL, KC_Z)
#define AC_TM3    ACTION_MODS_TAP_KEY(MOD_RSFT, KC_X)
#define AC_TM4    ACTION_LAYER_TAP_KEY(3, KC_N)
...
const action_t PROGMEM actionmaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    TM2,    TM3,    TL3,    TL4,    TL2,    TL1,    TL5,    TM4,    TM5,    BSPACE),
    [1] = ACTIONMAP( \
    1,      2,      3,      4,      5,      6,      7,      8,      9,      0, \
    ...
    MINS,   S12,    QUOT,   S20,    SLSH,   BSLS,   DOT,    COMM,   UP,     SCLN, \
    S11,    EQL,    S18,    S15,    TRNS,   TRNS,   S19,    LEFT,   DOWN,   RGHT),
    [3] = ACTIONMAP( \
    TRNS,   TRNS,   TRNS,   TRNS,   TRNS,   TRNS,   TRNS,   TRNS,   LBRC,   RBRC, \
    TAB,    TRNS,   TRNS,   TRNS,   TRNS,   TRNS,   TRNS,   TRNS,   TRNS,   TRNS, \
    TRNS,   TRNS,   TRNS,   TRNS,   TRNS,   TRNS,   TRNS,   TRNS,   TRNS,   TRNS),
    [4] = ACTIONMAP( \
    TRNS,   TRNS,   TRNS,   TRNS,   TRNS,   TRNS,   TRNS,   TRNS,   S13,    S14, \
    TAB,    TRNS,   TRNS,   TRNS,   TRNS,   TRNS,   TRNS,   TRNS,   TRNS,   TRNS, \
    TRNS,   TRNS,   TRNS,   TRNS,   TRNS,   TRNS,   HOME,   PGDN,   PGUP,   END),
    [5] = ACTIONMAP( \
    CALC,   WHOM,   MAIL,   MYCM,   PSCR,   TRNS,   TRNS,   TRNS,   S16,    S17, \
